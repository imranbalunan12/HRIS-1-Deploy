          ...
          <div className="col">
            <Card className="shadow">
              <CardHeader className="border-0" style={{display:"flex"}}>
                <h2 className="mb-0">Attendance Logs Archive</h2>
              ...
              <Table className="align-items-center table-flush" responsive>
                ...
                <tbody>
                  <tr>
                    <th scope="row">SSS Deductions.csv</th>
                  ...
                  <tr>
                    <th scope="row">PhilHealth Deductions.csv</th>
                    <td>April 10 - April 25, 2021</td>
                    <td>April 30, 2021</td>
                    <td>John Doe</td>
                    <td className="text-right">
                  ...
                  <tr>
                    <th scope="row">Pag-IBIG Deductions.csv</th>
                  ...
                  <tr>
                    <th scope="row">BIR Deductions.csv</th>
                    <td>September 10 - September 25, 2021</td>
                    <td>September 30, 2021</td>
                    <td>John Doe</td>
                    <td className="text-right">
